        ...
        <div class="btn-group">
            @can('business-create', App\Enums\GuardType::ADMIN)
                <a href="{{ route('admin.businessOwner.create') }}" class="d-none d-sm-inline-block btn btn-purp shadow-sm">
                    <i class="fas fa-plus-circle fa-sm fa-fw"></i> @lang('messages.create') @lang('messages.businessOwner')
                </a>
            @endcan
        </div>
    </div>
                ...
                <table class="table table-hover" id="datatable">
                    ...
                    @foreach($businessOwners as $businessOwner)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.businessOwner.edit', $businessOwner->id) }}" class="btn btn-block btn-purp @if(!$businessOwner->business()->exists()) disabledN @endif">
