   ...
   <div class="container" style="box-shadow: 0px 0px 2px 0px gray;background-color:white !important;" >
     <div class="row">
      <div class="col-lg-4 mt-3">
         <img src="{{ url($business->logo_url) }}" class="d-block m-auto" alt="Business Logo" style="max-width: 120px;align-items: center;" >
         <hr>
                  ...
                  <a href="{{ route('service.list', $staff->id) }}" title="Read more" class="read-more" >
                     <div class="card">
                        <div class="card-block block-3 m-xs-0">
                           ...
                           <h3 class="card-title"  style="margin-left: 85px;margin-bottom: 5px;">{{ $staff->name }}</h3>
                           <p class="card-text"  style="margin-left: 90px;opacity: .7;margin-bottom: 2px;">{{ $business->name }}</p>
